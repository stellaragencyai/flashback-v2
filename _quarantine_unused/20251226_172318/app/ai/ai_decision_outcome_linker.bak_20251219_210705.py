...
"""
Flashback — AI Decision ↔ Outcome Linker (Phase 4/5) v1.3

PATCH v1.3 (2025-12-18):
- Index ONLY event_type=="ai_decision" rows.
- Do NOT skip rows just because extra.stage exists (backfill + executor lifecycle still count).
- Deterministic pick using outcome account_label/symbol.
