...
# -*- coding: utf-8 -*-
"""
Flashback — AI Learning Builder v1.2 (Phase 6)
...
- trimmed_mean_R (default 10% trim)
- winsor_mean_R (default 10% winsor)

Drift:
- Compare recent window vs long window (trade-count based)
- Flags only; does not block execution
