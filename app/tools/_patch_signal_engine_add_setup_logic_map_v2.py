...
# Only refuse if an actual assignment exists
if re.search(r"(?m)^\s*SETUP_LOGIC\s*=", s):
    raise SystemExit("REFUSE: SETUP_LOGIC assignment already exists in signal_engine.py")
...
print("OK: inserted SETUP_LOGIC assignment (minimal v1) after compute_simple_signal() [v2]")
